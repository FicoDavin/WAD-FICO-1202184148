...
<body>
    ...
    <h1 class="font1">EAD HOTEL</h1>
    <h5 class="font1">Welcome To 5 Star Hotel</h5>
            ...
            <div class="col-4">
                <div class="div-dalam">
                        ...
                        <table style="margin-bottom: 0px;" class="table table-striped">
                            <thead>
                                ...
                                <tr class="table-Default">
                                    <th scope="col" class="ukuran">

                                        1 Singel Bed</th>

                                </tr>
                                <tr class="table-Default">
                                    <th scope="col" class="ukuran"> 1 Bathroom
                                        with hot water</th>
                    ...
                    <div class="tombol">
                        ...
                        <a href="booking.php?judul=Standard"><button type="button" class="button-1">Book now</button></a>
            ...
            <div class="col-4">
                ...
                <div class="div-dalam">
                    ...
                    <div>
                        ...
                        <img style="border-radius: 0,5px;" src="kamar 2.jpg" />
                    </div>
                    <h5 class="judul">Superior</h5>
                    <p class="harga">$ 180/Day</p>
                    <br><br>
                    <div>
                        <table style="margin-bottom: 0px;" class="table table-striped">
                            <thead>
                                ...
                                <tr class="table-Default">
                                    <th scope="col" class="ukuran"> 2 Bathroom
                                        with hot water</th>
                    ...
                    <div class="tombol">
                        ...
                        <a href="booking.php?judul=Superior"><button type="button" class="button-1">Book now</button></a>
            ...
            <div class="col-4">
                ...
                <div class="div-dalam">
                    ...
                    <div class="tombol">
                        ...
                        <a href="booking.php?judul=Luxury"><button type="button" class="button-1">Book now</button></a>
